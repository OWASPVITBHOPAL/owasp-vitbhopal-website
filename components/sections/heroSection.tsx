...
const HeroSection = () => {
  ...
  return (
    <Container className="px-4 md:px-6 lg:px-8">
      <div className="relative w-full min-h-62.5 h-[80vh] md:h-[70vh] md:min-h-125 flex items-center justify-center my-0 md:my-16 overflow-hidden">
        ...
        <div className="absolute h-full inset-0 flex items-center justify-center z-10 pointer-events-none px-2 md:hidden">
          <div className="shrink-0 flex flex-col select-none w-full items-center">
        ...
        <div className="absolute inset-0 hidden md:flex flex-col items-center justify-center z-10 pointer-events-none px-2">
          <div className="shrink-0 flex flex-col select-none w-full">
            ...
            <div className="flex flex-row justify-end items-center w-full pr-8 md:pr-16">
              <div className="w-32 lg:w-40 border-[3px] lg:border-4 border-[#ABABAB] mr-4" />
