...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(
          "Thank you for reaching out, expect a response soon! Keep an eye out on your inbox !",
        );
  ...
  return (
    <Container className="min-h-screen px-4 md:px-6 lg:px-8">
      ...
      <Header title="Contact Us">
        ...
        Reach out to the OWASP VIT Bhopal team and connect with our
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="flex h-full flex-col justify-between gap-3 rounded-3xl bg-[#121212] p-4 shadow-[inset_2px_2px_8px_0px_rgba(255,255,255,0.05),inset_1px_0px_8px_0px_rgba(255,255,255,0.01)] md:gap-4 md:p-6">
              ...
              <div className="text-sm leading-6 font-light text-[var(--muted)] md:text-base">
                Do you have any questions or suggestions for us? We&apos;d love
                to hear from you!
              </div>
              ...
              <div className="flex-start flex items-center gap-x-2 rounded-3xl bg-[#121212] p-3 shadow-[inset_2px_2px_8px_0px_rgba(255,255,255,0.05),inset_1px_0px_8px_0px_rgba(255,255,255,0.01)] transition-colors hover:bg-[#181818] md:p-4">
                ...
                <div className="text-sm font-semibold break-all md:text-base lg:text-lg">
              ...
              {/* Social Media Links */}
              <div className="gap-auto flex flex-col">
