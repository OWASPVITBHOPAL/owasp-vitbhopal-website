  ...
  return (
    <Container className='min-h-screen overflow-x-hidden px-4 md:px-6 lg:px-8'>
      <Header title='About Us'>
        The OWASP VIT Bhopal Student Chapter is dedicated to advancing web application security through education, research, and hands-on practice in the field of cybersecurity.      </Header>
